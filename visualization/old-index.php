...
//echo var_dump($wellnames);
if ($wellnames) {
	if ($startdate <= $enddate) {
//gets the serial that has the wellname
...
/*        if (!$arrdata) {
                echo "No data for this selection.";
                exit;
*/        }
}//endfor
...
<div id="main-wrapper" class="clearfix"><!--<div id="main" class="clearfix section region region-content">-->
...
$(document).ready(function() {
        ...
        $("#save_as_svg").click(function() { submit_download_form("svg"/*, this.id*/); });
	...
	$(".save_as_csv").click(function() { dlCSV(this.id, <?= json_encode($querys);?>);});
